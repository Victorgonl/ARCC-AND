        ...
        """ wandb.log(
            {
                ...
                "train/epoch_avg_recall": np.mean(train_recs_perbs),
                ...
                """ wandb.log(
                    {
                        ...
                        "valid/step_pre": precision,
                        "valid/step_recall": recall,
                        "valid/step_f1": f1,
            ...
            """ wandb.log(
                {
                    ...
                    "valid/epoch_avg_f1": np.mean(test_f1s_perepoch),
                    "epochs": ep,
