...
semantic_emb_bert_path = "{}/{}/{}".format(
    BasePath, config["processed_path"], config["semantic_emb_bert"]
)
semantic_emb_w2v_path = "{}/{}/{}".format(
...
sem_emb_vector_w2v_path = "{}/{}/{}".format(
    BasePath, config["processed_path"], config["sem_emb_vector_w2v"]
)
